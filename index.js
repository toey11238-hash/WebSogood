...
async function handleSlashCommand(interaction) {
  ...
  if (commandName === 'trivia') {
    ...
    try {
      ...
      const msg = await interaction.fetchReply();
      activeTrivia.set(msg.id, { correctAnswer: q.correctAnswer, allAnswers: q.allAnswers, xpReward: q.xpReward, answered: false });
      setTimeout(() => activeTrivia.delete(msg.id), 5 * 60 * 1000); // เก็บกวาดกันหน่วยความจำบวมถ้าไม่มีคนตอบเลย
      return;
    } catch (e) {
