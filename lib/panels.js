...
const { MODE_LABELS, calculateLevel, parseRoleRewards } = require('./storage');
const { parseApiKeys, detectApiProvider } = require('./ai');

// 👇 3 บรรทัดที่เพิ่มเข้ามาเพื่อแก้บอทพัง 👇
const globalConfig = require('../config.json');
const IMAGE_GEN_COOLDOWN_SECONDS = 60;
const PANEL_COMMAND = '!anurak';
// 👆 ======================= 👆
